...
//		if (head == NULL)
//		{
//			cout << "No node to sort\n";
//			return;
//		}
//		if (head->getnext() == NULL)
//		{
//			cout << "Only one node cannot be sorted\n";
//			return;
//		}
//		node* temp = head;
//		while (temp != NULL)
...
//			while (temp2 != NULL)
//			{
//				if (temp->getdata() > temp2->getdata())//sorting keys and data of these nodes
//				{
//					int tempdata = temp2->getdata();
//					temp2->setdata(temp->getdata());
//					temp->setdata(tempdata);
//					int tempkey = temp2->getkey();
...
//		if (head == NULL)
//		{
//			cout << "No node remove dublicate\n";
//			return;
//		}
//		if (head->getnext() == NULL)
//		{
//			cout << "Only one dublicate\n";
//			return;
//		}
//		node* temp = head;
//		while (temp != NULL)
...
//			{
//				if (temp->getdata() == temp2->getnext()->getdata())	//compiaring one with all and removing
//				{
//					node* to_del = temp->getnext();
//					temp->setnext(temp->getnext()->getnext());
//					delete to_del;
